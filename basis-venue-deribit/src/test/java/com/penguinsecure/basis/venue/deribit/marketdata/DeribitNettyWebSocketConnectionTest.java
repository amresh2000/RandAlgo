...
@Tag("unit")
final class DeribitNettyWebSocketConnectionTest {
    @Test
    void forwardsHandshakeCompletionExactlyOnce() {
        ...
        EmbeddedChannel channel =
                new EmbeddedChannel(new DeribitNettyWebSocketConnection.HandshakeEvents(listener));
        channel.pipeline()
    ...
    void requiresSecureEndpointAndSingleSessionBinding() throws Exception {
        ...
        try {
            ...
            DeribitNettyWebSocketConnection connection =
                    new DeribitNettyWebSocketConnection(
            ...
            connection.bindSessionListener(DeribitSessionListener.NOOP);
            assertThrows(
